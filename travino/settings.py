"""
Django settings for travino project.
...
SECRET_KEY = 'django-insecure-5w-*s7#9)+z^sk0mp1go*4gl36en+knir)se8hfu5n&9z_ejc9'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://92c6-91-93-239-182.ngrok-free.app',
...
WSGI_APPLICATION = 'travino.wsgi.application'
...
STORAGES = {
    "default": {
        ...
        "OPTIONS": {
            "location": BASE_DIR / "media",  # Ensure 'media' folder exists in your project root
            "base_url": "/media/",
        },
    },
    "staticfiles": {
...
AUTHENTICATION_BACKENDS = ['app.authentication.EmailBackend', 'django.contrib.auth.backends.ModelBackend']
